...
var velx = instance_nearest(obj_transmission_tower.x, obj_transmission_tower.y, obj_enemy).x - self.x
var vely = instance_nearest(obj_transmission_tower.x, obj_transmission_tower.y, obj_enemy).y - self.y
